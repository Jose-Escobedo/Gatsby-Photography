    ...
    <Layout>
      ...
      <ContactFormStyled>
        <div className="contact-wrapper">
          <form
            action="https://getform.io/f/6c9a1f4e-2208-46ee-bd22-ba2b3af42087"
            method="POST"
          >
          ...
          <div className="direct-contact-container">
            ...
            <div className="copyright">Jose Escobedo &copy;2023</div>
          </div>
        </div>
      </ContactFormStyled>
    </Layout>
...
const ContactFormStyled = styled.div`
  ...
  background: linear-gradient(#010106, grey) padding-box;
